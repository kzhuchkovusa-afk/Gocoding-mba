...
// ===========================
// Kommo Form Modal Handler
// ===========================

function openKommoForm() {
    const modal = document.getElementById('kommoFormModal');
    const container = document.getElementById('kommoFormContainer');
    
    // Show modal
    modal.classList.add('active');
    document.body.style.overflow = 'hidden';
    
    // Load Kommo form if not already loaded
    if (!container.querySelector('iframe') && !container.querySelector('.amoforms-embed')) {
        // Create iframe with Kommo form
        const iframe = document.createElement('iframe');
        iframe.src = 'https://forms.kommo.com/1640016';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Close button
    if (closeBtn) {
        closeBtn.addEventListener('click', closeKommoForm);
    }
...
window.openKommoForm = openKommoForm;
window.closeKommoForm = closeKommoForm;